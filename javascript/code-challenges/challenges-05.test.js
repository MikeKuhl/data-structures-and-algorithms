...
const addPurchases = (arr) => {
  // Solution code here...
  const reducer = (acc, currentValue) => acc + currentValue.purchasePrice;
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const reducer = (previousValue, items) => (previousValue = items++);
...
const returnNames = (arr) => {
  ...
  let newArr = [];
  const reducer = (acc, currentValue) => newArr.push((acc = currentValue.name));
