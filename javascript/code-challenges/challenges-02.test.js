...
For example, twoToThe([1,2,3]) returns [2,4,9] because 2 ^ 1 = 2, 2 ^ 2 = 4, and 2 ^ 3 = 9.
------------------------------------------------------------------------------------------------ */
...
const mapTwoToThe = (arr) => {
  const mapped = arr.map((i) => Math.pow(i, 2));
  return mapped;
};
